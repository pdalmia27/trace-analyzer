...
def test_visualizer_renders_expected_sections_from_analyzer_outputs(tmp_path):
    ...
    for text in [
        ...
        "New prefill work by turn bucket",
        "Non-OSL prefix growth by 10-turn bucket for the same top tasks",
        "Prefill vs decode work by turn",
        "OSL by turn bucket",
        "Completion-token distribution by 10-turn bucket for the same top tasks",
